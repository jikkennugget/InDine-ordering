...
public class Helper
{
    ...
    // ------------------------------------------------------------------------
    // Simple Photo Upload Helper Functions
    // ------------------------------------------------------------------------
    // 
    // Features:
    // - Simple resize to 200x200 to fit UI design
    ...
    public string ValidatePhoto(IFormFile f)
    {
        ...
        {
            return "Photo size cannot more than 100MB.";
        }
    ...
    public string SavePhoto(IFormFile f, string folder)
    {
        ...
        // Simple resize to fit UI design - 200x200 for most cases
    ...
    public string SavePhoto(IFormFile f, string folder, string customFileName)
    {
        // Sanitize the custom filename to ensure it's safe for file system
        var sanitizedFileName = SanitizeFileName(customFileName) + ".jpg";
        var path = Path.Combine(en.WebRootPath, folder, sanitizedFileName);

        // Debug: Log the filename being used
        System.Diagnostics.Debug.WriteLine($"SavePhoto: Using custom filename: {sanitizedFileName}");
